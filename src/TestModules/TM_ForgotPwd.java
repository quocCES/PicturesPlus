...
public class TM_ForgotPwd {
	...
	@Test
	public void TC_051() {
		forgotPassword.forgotPwd(driver, "");
	...
	public void TC_050() {
		...
		forgotPassword.forgotPwd(driver, "autotTest@mailinator.com");
		Assert.assertTrue(driver.getTitle().trim().equals("Customer Login | Picture Plus"));
		String expectedMessage = "If there is an account associated with autotTest@mailinator.com you will receive an email with a link to reset your password.";
